/*5. Библиотечная функция islower() принимает в качестве аргумента один символ (букву) и возвращает ненулевое целое значение в том случае, 
...
int main()
{
    char enter;
    if(std::cin >> enter)
        std::cout << (islower((unsigned char) enter) != 0) << std::endl;
    return 0;
}