// В файле реализации, приведенном в листинге 14.8, осуществляется инициализация этого массива и содержатся определения методов. 
// Листинг 14.8. worker0.срр 
// workerO.cpp --методы классов работников 
